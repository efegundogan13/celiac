...
class Event:
    """A single events for a ActiveX named object."""
...
class EventSink:
    ...
    def _invoke_(self, dispid, lcid, wFlags, args):
        ...
        # print("Invoke for ", events, "on", self.myScriptItem, " - calling",  self.myInvokeMethod)
    ...
    def BuildEvents(self):
        ...
        try:
            ...
            try:
                ...
                numTypeInfos = 0
        # Create an events handler for the item.
...
class ScriptItem:
    ...
    def CreateConnections(self):
        ...
        # Nothing to do unless this is an events source
    ...
    def FindBuildSubItemEvents(self):
        # Called during connection to events source.  Seeks out and connects to
            ...
            while 1:
                ...
                if isSubObject:
                    try:
                        ...
                        # all refer to the same object.  Our events implementation code does not differentiate
                        # eg, "window_onload" will fire for *all* objects named "window".  Thus,
                        # "window" and "window.window" will fire the same events handler :(
                        # One option would be to check if the sub-object is indeed the
                        # parent object - however, this would stop "top_onload" from firing,
                        # as no events handler for "top" would work.
                        # I think we simply need to connect to a *single* events handler.
...
class COMScript:
    ...
    def ParseProcedureText(
        ...
        # However, the "procName" is always an empty string - ie, itemName is the object whose events we are handling,
        # but no idea what the specific events is!?
        # Problem is disabling this block is that AddScriptlet is _not_ passed
        # <SCRIPT for="whatever" events="onClick" language="Python">
    ...
    def ProcessScriptItemEvent(self, item, event, lcid, wFlags, args):
        # 		trace("ProcessScriptItemEvent", item, events, lcid, wFlags, args)
        self.RegisterNewNamedItems()
