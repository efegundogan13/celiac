...
class NewLispLexer(RegexLexer):
    ...
    builtins = (
        ...
        'close', 'command-events', 'cond', 'cons', 'constant',
        ...
        'empty?', 'encrypt', 'ends-with', 'env', 'erf', 'error-events',
        ...
        'xfer-events', 'xml-error', 'xml-parse', 'xml-type-tags', 'zero?',
    )
...
class EmacsLispLexer(RegexLexer):
    ...
    builtin_function = {
        ...
        'events-convert-list', 'execute-kbd-macro', 'exit-recursive-edit',
        ...
        'internal-events-symbol-parse-modifiers',
        ...
        'read-coding-system', 'read-command', 'read-events',
        ...
        'start-process', 'stop-process', 'store-kbd-macro-events', 'string',
