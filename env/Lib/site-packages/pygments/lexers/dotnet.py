        ...
        tokens[levelname] = {
            'root': [
                ...
                (words((
                    ...
                    'delegate', 'do', 'else', 'enum', 'events', 'explicit',
        ...
        tokens[levelname] = {
            'root': [
                ...
                (r'(abstract|and|as|base|catch|def|delegate|'
                 r'enum|events|extern|false|finally|'
    ...
    tokens = {
        'root': [
            ...
            (r'(as|abstract|callable|constructor|destructor|do|import|'
             r'enum|events|final|get|interface|internal|of|override|'
...
class FSharpLexer(RegexLexer):
    ...
    keywords += [
        ...
        'constructor', 'continue', 'eager', 'events', 'external', 'fixed',
