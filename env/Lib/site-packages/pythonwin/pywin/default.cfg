...
#Events of the format <<events-name>>
...
[Extensions]
# Python events handlers specific to this config file.
...
# * events is the events being fired.  Will always be None
...
# Here is a sample events bound to the "Home" key in the
# interactive window
