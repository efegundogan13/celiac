...
class ADOEvents:  # events handler class
    def OnWillConnect(self, str, user, pw, opt, sts, cn):
        # Must have this events, as if it is not handled, ADO assumes the
...
def TestConnection(dbname):
    # Create the ADO connection object, and link the events
    # handlers into it
    ...
    # Sit in a loop, until our events handler (above) sets the
