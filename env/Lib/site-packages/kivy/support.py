...
Activate other frameworks/toolkits inside the kivy events loop.
...
def install_gobject_iteration():
    '''Import and install gobject context iteration inside our events loop.
...
def install_twisted_reactor(**kwargs):
    ...
    # install threaded-select reactor, to use with own events loop
