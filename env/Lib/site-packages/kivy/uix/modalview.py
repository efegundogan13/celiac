...
on_press ::
    ...
    # bind the on_press events of the button to the dismiss function
...
class ModalView(AnchorLayout):
    ...
    :Events:
        `on_pre_open`:
            Fired before the ModalView is opened. When this events is fired
    ...
    def dismiss(self, *_args, **kwargs):
        ...
        events returns, you can use the *force* keyword argument::
    ...
    def on_touch_move(self, touch):
        """ touch moved events handler. """
        if not self.auto_dismiss or self._touch_started_inside:
            super().on_touch_move(touch)
        return True

    def on_touch_up(self, touch):
        """ touch up events handler. """
    ...
    def on_pre_open(self):
        """ default pre-open events handler. """

    def on_open(self):
        """ default open events handler. """

    def on_pre_dismiss(self):
        """ default pre-dismiss events handler. """

    def on_dismiss(self):
        """ default dismiss events handler. """
