...
class Scatter(Widget):
    ...
    def on_touch_down(self, touch):
        ...
        # let the child widgets handle the events if they want
        touch.push()
    ...
    def on_transform_with_touch(self, touch):
        '''
        Called when a touch events has transformed the scatter widget.
    ...
    def on_bring_to_front(self, touch):
        '''
        Called when a touch events causes the scatter to be brought to the
