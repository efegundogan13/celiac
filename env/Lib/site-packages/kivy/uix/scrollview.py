...
touch down events is dispatched to the child instead (no translation).
...
class ScrollView(StencilView):
    ...
    :Events:
        `on_scroll_start`
            Generic events fired when scrolling starts from touch.
        `on_scroll_move`
            Generic events fired when scrolling move from touch.
        `on_scroll_stop`
            Generic events fired when scrolling stops from touch.
    ...
    to scroll, and no touch events will go to children.
    ...
    the scrolling will be disabled, and the touch events will go to the
    children.
    ...
    def _do_touch_up(self, touch, *largs):
        ...
        touch.pop()
        # don't forget about grab events!
