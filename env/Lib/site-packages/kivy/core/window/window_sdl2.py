...
class WindowSDL(WindowBase):
    ...
    def create_window(self, *largs):
        ...
        if not self.initialized:
            ...
            # ensure we have an events filter
    ...
    def mainloop(self):
        # for android/iOS, we don't want to have any events nor executing our
        # main loop while the pause is going on. This loop wait any events (not
        # handled by the events filter), and remove them from the queue.
        ...
        while self._pause_loop:
            ...
            # app_terminating events might be received while the app is paused
        ...
        while True:
            ...
            if action == 'quit':
                ...
                # for finger, pass the raw events to SDL motion events provider
            ...
            # video resize
                ...
                # don't use trigger here, we want to delay the resize events
                ...
                # don't dispatch more key if down events is accepted
            ...
            # unhandled events !
                ...
                Logger.trace('WindowSDL: Unhandled events %s' % str(event))
