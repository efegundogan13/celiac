...
class WindowBase(EventDispatcher):
    ...
    :Events:
        `on_motion`: etype, motionevent
            ...
            dispatched
        `on_touch_down`:
            Fired when a new touch events is initiated.
        `on_touch_move`:
            Fired when an existing touch events changes location.
        `on_touch_up`:
            Fired when an existing touch events is terminated.
        `on_draw`:
        ...
        `on_request_close`:
            Fired when the events loop wants to close the window, or if the
            escape key is pressed and `exit_on_escape` is `True`. If a function
            bound to this events returns `True`, the window will not be closed.
            If the events is triggered because of the keyboard escape key,
    ...
    '''Holds a `dict` of `type_id` to `list` of events managers.
    ...
    def register(self):
        if self.initialized:
            return
        # attach modules + listener events
        EventLoop.set_window(self)
        Modules.register_window(self)
        EventLoop.add_event_listener(self)

    def register_event_manager(self, manager):
        '''Register and start an events manager to handle events declared in
    ...
    def unregister_event_manager(self, manager):
        '''Unregister and stop an events manager previously registered with
    ...
    def set_custom_titlebar(self, widget):
        ...
        | `False` if you want to receive the touch events at the point
    ...
    def transform_motion_event_2d(self, me, widget=None):
        '''Transforms the motion events `me` to this window size and then if
    ...
    def on_motion(self, etype, me):
        '''Event called when a motion events is received.

        :Parameters:
            `etype`: str
                One of "begin", "update" or "end".
            `me`: :class:`~kivy.input.motionevent.MotionEvent`
                The motion events currently dispatched.

        .. versionchanged:: 2.1.0
            Event managers get to handle the touch events first and if none of
            them accepts the events (by returning `True`) then window will
        ...
        if me.is_touch:
            ...
            # be used restore previous values of events's attributes
            # me.push()
    ...
    def on_touch_down(self, touch):
        '''Event called when a touch down events is initiated.
    ...
    def on_touch_move(self, touch):
        '''Event called when a touch events moves (changes location).
    ...
    def on_touch_up(self, touch):
        '''Event called when a touch events is released (terminated).
    ...
    def on_request_close(self, *largs, **kwargs):
        ...
        `True`, the window will not be closed. If the events is triggered
    ...
    def on_keyboard(self, key, scancode=None, codepoint=None,
        ...
        # Consume the events and tell Android to pause.
    ...
    def on_textinput(self, text):
        ...
        character or multiple ones, this events supports handling multiple
        characters.
    ...
    def on_drop_begin(self, x, y, *args):
        ...
        .. note::
            This events works with sdl2 window provider.
    ...
    def on_drop_file(self, filename, x, y, *args):
        ...
        .. warning::
            This events currently works with sdl2 window provider, on pygame
            window provider and OS X with a patched version of pygame.
            This events is left in place for further evolution
            (ios, android etc.)
        ...
        .. note::
            This events doesn't work for apps with elevated permissions,
    ...
    @deprecated(msg='Deprecated in 2.1.0, use on_drop_file events instead. '
    ...
    def on_drop_text(self, text, x, y, *args):
        ...
        .. note::
            This events works with sdl2 window provider on x11 window.
    ...
    def on_memorywarning(self):
        ...
        Currently, this events is fired only from the SDL2 provider, for
        iOS and Android.
