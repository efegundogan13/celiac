...
class Image(EventDispatcher):
    ...
    .. versionchanged:: 1.0.8
        ...
        An Image widget can change its texture. A new events 'on_texture' has
    ...
    def __init__(self, arg, **kwargs):
        # this events should be fired on animation of sequenced img's
    ...
    def on_texture(self, *largs):
        '''This events is fired when the texture reference or content has
