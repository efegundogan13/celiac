        ...
        .. code-block:: python
            ...
            class Example(MDApp):
                ...
                def on_ref_press(
                    ...
                    '''
                    The method will be called when the ``on_ref_press`` events
...
class MDTabsScrollView(ScrollView):
    ...
    def goto(
        ...
        """Update events value along with scroll_*."""
...
class MDTabs(
    ...
    def on_slide_progress(self, *args) -> None:
        """
        This events is deployed every available frame while the tab is scrolling.
        """
    ...
    def on_carousel_index(self, instance_tabs_carousel, index: int) -> None:
        ...
        This events is deployed by the built in carousel of the class.
        """
    ...
    def on_ref_press(self, *args) -> None:
        """
        This events will be launched every time the user press a markup enabled
        label with a link or reference inside.
        """

    def on_tab_switch(self, *args) -> None:
        """This events is launched every time the current tab is changed."""
