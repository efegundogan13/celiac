...
class TestPipeService(win32serviceutil.ServiceFramework):
    ...
    def SvcDoRun(self):
        # Write an events log record - in debug mode we will also
        ...
        while 1:
            ...
            if hr == winerror.ERROR_PIPE_CONNECTED:
                # Client is already connected - signal events
            ...
            if rc == WAIT_OBJECT_0:
                ...
                # Pipe events - spawn thread to deal with it.
        ...
        # Write another events log record.
        servicemanager.LogMsg(
            servicemanager.EVENTLOG_INFORMATION_TYPE,
