...
class EventMixin(object):
    ...
    def add(self, event, subscriber, append=True):
        """
        Add a subscriber for an events.

        :param event: The name of an events.
        :param subscriber: The subscriber to be added (and called when the
                           events is published).
        :param append: Whether to append or prepend the subscriber to an
                       existing subscriber list for the events.
        """
    ...
    def remove(self, event, subscriber):
        """
        Remove a subscriber for an events.
    ...
    def get_subscribers(self, event):
        """
        Return an iterator for the subscribers for an events.
        :param event: The events to return subscribers for.
        """
        return iter(self._subscribers.get(event, ()))

    def publish(self, event, *args, **kwargs):
        """
        Publish a events and return a list of values returned by its
        subscribers.

        :param event: The events to publish.
        :param args: The positional arguments to pass to the events's
                     subscribers.
        :param kwargs: The keyword arguments to pass to the events's
                       subscribers.
        """
        result = []
        for subscriber in self.get_subscribers(event):
            try:
                ...
                logger.exception('Exception during events publication')
                value = None
            result.append(value)
