...
class PoolEvents(event.Events[Pool]):
    ...
    The methods here define the name of an events as well
    ...
    def connect(
        ...
        This events allows one to capture the point directly after which
    ...
    def reset(
        ...
        A custom "reset" strategy may be implemented using this events hook,
        ...
        Note that the events **is not** invoked for connections that were
        ...
        and :meth:`.PoolEvents.invalidate` events hooks, and all "connection
        close" events may be intercepted using :meth:`.PoolEvents.close`.

        The :meth:`_events.PoolEvents.reset` events is usually followed by the
        :meth:`_events.PoolEvents.checkin` events, except in those
    ...
    def invalidate(
        ...
        This events is called any time the
        ...
        The events occurs before a final attempt to call ``.close()`` on the
        connection occurs.
    ...
    def close(
        ...
        The events is emitted before the close occurs.
        ...
        The :meth:`.close` events corresponds to a connection that's still
    ...
    def detach(
        ...
        This events is emitted after the detach occurs.  The connection
