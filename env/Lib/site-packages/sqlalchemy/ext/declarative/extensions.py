...
class ConcreteBase:
    ...
    a hook for the :meth:`.after_configured` events.
...
class AbstractConcreteBase(ConcreteBase):
    ...
    a hook for the :meth:`.before_configured` events.
    ...
    .. note::
        ...
        **mapper configuration events** to occur, at which point it scans
        through all the configured subclasses and sets up a mapping that will
        query against all subclasses at once.

        While this events is normally invoked automatically, in the case of
