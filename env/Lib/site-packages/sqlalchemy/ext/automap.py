...
events hook :meth:`_events.DDLEvents.column_reflect` that may be used to intercept
...
naming convention such as ``"attr_<columnname>"``, the events could
be applied as::

    @events.listens_for(Base.metadata, "column_reflect")
...
.. versionadded:: 1.4.0b2 the :meth:`_events.DDLEvents.column_reflect` events
