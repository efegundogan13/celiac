...
of this type, applying events listening instrumentation to the mapped
...
The :meth:`.AttributeEvents.modified` events handler may be used to receive
an events when a mutable scalar emits a change events.  This events handler
...
from within the mutable extension::
    ...
    @events.listens_for(MyDataClass.data, "modified")
...
class Mutable(MutableBase):
    ...
    def as_mutable(cls, sqltype: _TypeEngineArgument[_T]) -> TypeEngine[_T]:
        ...
        the given type, adding mutation events trackers to those mappings.
