...
* :class:`.ExecutableDDLElement` - The root of all DDL expressions,
  ...
  :class:`.ExecutableDDLElement` can also be used as an events hook in
  conjunction with events hooks like :meth:`.DDLEvents.before_create` and
  ...
  .. seealso::
    ...
    instances) with :class:`.DDLEvents` events hooks.
