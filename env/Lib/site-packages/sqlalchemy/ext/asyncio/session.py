...
class AsyncSession(ReversibleProxy[Session]):
    ...
    This instance can be used as an events target.
    ...
    async def run_sync(
        ...
        **kw: _P.kwargs,
        ...
        This method maintains the asyncio events loop all the way through
        to the database connection by running the given callable in a
        specially instrumented greenlet.

        .. tip::

            The provided callable is invoked inline within the asyncio events
    ...
    def get_bind(
        ...
        **kw: Any,
        ...
        implicitly non-blocking context in the same manner as ORM events hooks
    ...
    def begin(self) -> AsyncSessionTransaction:
        ...
        events hook that may perform IO.
