...
class Connection(ConnectionEventsTarget, inspection.Inspectable["Inspector"]):
    ...
    def execution_options(self, **opt: Any) -> Connection:
        ...
        :param isolation_level: Available on: :class:`_engine.Connection`,
          ...
          events handler will emit additional statements on the DBAPI connection
    ...
    def invalidate(self, exception: Optional[BaseException] = None) -> None:
        ...
        :meth:`_events.PoolEvents.invalidate` events.

        :param exception: an optional ``Exception`` instance that's the
         reason for the invalidation.  is passed along to events handlers
    ...
    def begin(self) -> RootTransaction:
        ...
        events at a specific time, or to organize code within the scope of a
    ...
    def _execute_default(
        ...
        # note for events handlers, the "distilled parameters" which is always
    ...
    def _handle_dbapi_exception(
        ...
        try:
            ...
            if not self._is_disconnect:
                ...
                # scenario in any case using an events handler.
...
class Engine(
    ...
    def execution_options(self, **opt: Any) -> OptionEngine:
        ...
        * The logging configuration and logging_name is copied from the parent
        ...
        uses a custom option ``shard_id`` which is consumed by an events
        to change the current schema on a database connection::
            ...
            @events.listens_for(Engine, "before_cursor_execute")
        ...
        :meth:`_events.ConnectionEvents.before_cursor_execute` events handler
    ...
    def connect(self) -> Connection:
        ...
        emit the :meth:`_events.ConnectionEvents.rollback` events if one was
