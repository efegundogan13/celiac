...
def create_engine(url: Union[str, _url.URL], **kwargs: Any) -> Engine:
    ...
    :param creator: a callable which returns a DBAPI connection.
        ...
        .. seealso::
            ...
            :meth:`_events.DialectEvents.do_connect` - events hook that allows
    ...
    if _initialize:
        ...
        # previously, the "first_connect" events was used here, which was then
        # scaled back if the "on_connect" handler were present.  now,
        # since "on_connect" is virtually always present, just use
        # "connect" events with once_unless_exception in all cases so that
        # the connection events flow is consistent in all cases.
        event.listen(
