...
class Dialect(EventTarget):
    ...
    def on_connect(self) -> Optional[Callable[[Any], Any]]:
        ...
        :meth:`_events.PoolEvents.connect` events
        ...
        If None is returned, no events listener is generated.
    ...
    def get_isolation_level_values(
        ...
        * Other isolation modes may also be present, provided that they
        ...
        A DBAPI connection is passed to the method, in the unlikely events that
    ...
    def set_engine_execution_options(
        ...
        events hooks for new :class:`.Connection` instances created
...
class CreateEnginePlugin:
    ...
    systems to apply engine, pool and dialect level events listeners without
    ...
    to an :class:`_engine.Engine` object might look like::
        ...
        class LogCursorEventsPlugin(CreateEnginePlugin):
            ...
            def engine_created(self, engine):
                "attach an events listener after the new Engine is constructed"
                events.listen(engine, "before_cursor_execute", self._log_event)
            ...
            def _log_event(
                ...
                self.log.info("Plugin logged cursor events: %s", statement)
...
class ExceptionContext:
    ...
    :meth:`_events.DialectEvents.handle_error` events,
    ...
    This member is present for all invocations of the events hook.
    ...
    and will be raised if exception handling is not circumvented by the events.
    ...
    :meth:`_events.ConnectionEvents.before_cursor_execute` events or similar
    ...
    assigning to this flag, a "disconnect" events which then results in
    ...
    .. note:: The pool "pre_ping" handler enabled using the
        ...
        consult this events before deciding if the "ping" returned false,
    ...
    events will have the effect such
...
class AdaptedConnection:
    ...
    def run_async(self, fn: Callable[[Any], Awaitable[_T]]) -> _T:
        ...
        E.g.::
            ...
            @events.listens_for(engine.sync_engine, "connect")
