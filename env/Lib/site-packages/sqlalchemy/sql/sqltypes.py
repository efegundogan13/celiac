...
class SchemaType(SchemaEventTarget, TypeEngineMixin):
    ...
    def _set_parent(self, parent, **kw):
        ...
        # associated with a table.  in that events, we and all of our variants
    ...
    def _is_impl_for_variant(
        ...
        # that are SchemaEventTarget subclasses get set up as events holders.
...
class JSON(Indexable, TypeEngine[Any]):
    ...
    **Detecting Changes in JSON columns when using the ORM**
    ...
    replaces the old one will always trigger a change events.
