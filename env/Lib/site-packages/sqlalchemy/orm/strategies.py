...
def _register_attribute(
    ...
    **kw,
    ...
    # hierarchy, so we set up attribute instrumentation and backref events
...
class LazyLoader(
    ...
    def _emit_lazyload(
        ...
        if state.load_options or (loadopt and loadopt._extra_criteria):
            ...
            # in the query, but an events may want to add them
...
class SubqueryLoader(PostLoader):
    ...
    def _generate_from_original_query(
        ...
        # LEGACY: as "q" is a Query, the before_compile() events is invoked
        # here.
...
class JoinedLoader(AbstractRelationshipLoader):
    ...
    def _create_scalar_loader(self, context, key, _instance, populators):
        def load_scalar_from_joined_new_row(state, dict_, row):
            ...
            # object, bypassing InstrumentedAttribute events handlers.
