...
class BulkUDCompileState(ORMDMLState):
    ...
    def orm_setup_cursor_result(
        ...
        # do_orm_execute events hook.  meaning for an extension like
        # horizontal sharding, this step happens *within* the horizontal
        # sharding events handler which calls session.execute() re-entrantly
    ...
    def _do_pre_synchronize_fetch(
        ...
        # events.  If RETURNING is available, the do_orm_execute events
        ...
        # events?  Answer: because we are integrating with extensions such
