...
class collection:
    ...
    @util.deprecated(
        ...
        "conjunction with the :func:`.events.listen` function.",
    )
    def converter(fn):
...
class CollectionAdapter:
    ...
    def clear_with_event(
        ...
        """Empty the collection, firing a mutation events for each entity."""
...
def __set(collection, item, _sa_initiator, key):
    ...
    This events always occurs before the collection is actually mutated.
...
def __del(collection, item, _sa_initiator, key):
    ...
    This events occurs before the collection is actually mutated, *except*
...
def __before_pop(collection, _sa_initiator=None):
    """An events which occurs on a before a pop() operation occurs."""
    executor = collection._sa_adapter
    if executor:
