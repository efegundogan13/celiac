...
def _warn_for_runid_changed(state):
    util.warn(
        ...
        "events handler is expected to be "
        ...
        "listener to ensure the context remains unchanged when the events "
    ...
    def _instance(row):
        ...
        if currentload or effective_populate_existing:
            ...
            if isnew:
                ...
                # here, however for events checks we are being more conservative
