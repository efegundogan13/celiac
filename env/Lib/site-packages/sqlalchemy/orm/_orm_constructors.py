...
def with_loader_criteria(
    ...
    **globally**, meaning it will apply to the entity as it appears
    ...
    it in the :meth:`_orm.SessionEvents.do_orm_execute` events handler
    ...
    emitted by a particular :class:`_orm.Session`::
        ...
        @events.listens_for("do_orm_execute", session)
    ...
    events will intercept all queries emitted using the
    ...
    :param propagate_to_loaders: defaults to True, apply to relationship
     ...
     .. seealso::
        ...
        :meth:`_orm.SessionEvents.do_orm_execute` events.
...
def _mapper_fn(*arg: Any, **kw: Any) -> NoReturn:
    ...
    of using the ``mapper()`` function as a target for ORM events listeners,
    ...
    .. versionchanged:: 2.0  The ``mapper()`` function was removed; the
       symbol remains temporarily as a placeholder for the events listening
       use case.
