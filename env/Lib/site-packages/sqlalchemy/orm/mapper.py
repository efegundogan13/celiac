...
class Mapper(
    ...
    def __init__(
        ...
        :param eager_defaults: if True, the ORM will immediately fetch the
          ...
          This can be used for events schemes where the server-generated values
        ...
        :param polymorphic_on: Specifies the column, attribute, or
          ...
          either through manual means or via events listeners.
          ...
          looks like::
                ...
                @events.listens_for(Employee, "init", propagate=True)
    ...
    """The :class:`.ClassManager` which maintains events listeners
    ...
    def _configure_class_instrumentation(self):
        ...
        # this invokes the class_instrument events and sets up
        # the __init__ method.  documented behavior is that this must
        # occur after the instrument_class events above.
        ...
        manager = instrumentation.register_class(
            ...
            # and call the class_instrument events
            finalize=True,
        )
...
def configure_mappers() -> None:
    ...
    provides several events hooks that can be used to augment the mapper
...
def _dispose_registries(registries: Set[_RegistryType], cascade: bool) -> None:
    ...
    for reg in registry._recurse_with_dependents(registries):
        ...
        # the "before_configured" events even though mappers had all been
        # disposed.
        reg._new_mappers = False
...
def reconstructor(fn: _Fn) -> _Fn:
    ...
    .. tip::
        ...
        :meth:`_orm.InstanceEvents.load` events hook, which can be
        used directly.
...
def validates(
    *names: str, include_removes: bool = False, include_backrefs: bool = True
    ...
    :param include_backrefs: defaults to ``True``; if ``False``, the
     ...
     events related via a backref.  This can be used for bi-directional
